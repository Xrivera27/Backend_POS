...
const recuperarVentaGuardada = async (req, res) => {
  ...
  const generarFactura = async (req, res) => {
    console.log('1. Iniciando generación de factura...');
    const supabase = req.supabase;
    const id_venta = req.params.id_venta;
    const id_usuario = req.params.id_usuario;
  
    try {
      console.log('2. Verificando parámetros:', { id_venta, id_usuario });
      if (!id_venta || !id_usuario) {
        throw new Error('Parámetros incompletos');
      }
  
      console.log('3. Obteniendo id_sucursal...');
      const id_sucursal = await getSucursalesbyUser(id_usuario, supabase);
      ...
      console.log('4. Obteniendo datos de sucursal...');
      ...
      console.log('5. Obteniendo datos de empresa...');
      ...
      console.log('6. Obteniendo datos de venta...');
      ...
      console.log('7. Obteniendo detalles de venta...');
      ...
      console.log('8. Obteniendo datos SAR...');
      ...
      console.log('Datos SAR:', datosSAR);
      ...
      console.log('9. Creando documento PDF...');
      ...
      // Función helper para alinear texto y valor
      ...
      .fontSize(8)
         ...
         .text(`Factura: ${datosSAR.numero_actual_SAR}`)
      ...
      doc.text(' ', 10)
         ...
         .moveDown()
         .text(`CAI: ${datosSAR.numero_CAI}`, { align: 'center' })
   ...
   .text('EXIJALA', { align: 'center' });
      ...
      console.log('11. Finalizando documento...');
      doc.end();
      console.log('12. Documento PDF generado exitosamente');
