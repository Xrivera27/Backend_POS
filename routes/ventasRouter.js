...
const { getPrePage, getProductPage, verificarRtn, selectProductoCodigo, guardarVenta, getVentasGuardadas, recuperarVentaGuardada, postVenta, pagarFacturaEfectivo, eliminarProductoVenta } = require('../controllers/ventasController');
